...
class Fluid(
    ...
    """
    This block contains nonbibliographic information about the source of the
    ThermoML file contents, identifies the experimental purpose, specifies meta-
    and numerical data, and specifies the compound (or mixture) and particular
    samples to which the data are related.
    """
    ...
    variable: Optional[Variable] = element(
        default= None,
        tag="variable",
    ...
    constraint: list[Constraint] = element(
        default_factory=list,
        tag="constraint",
        description="""A constraint refers to a condition or a fixed parameter that applies to
            an entire data set, rather than to each individual data point.
            Constraints are used to define experimental or calculated conditions
            that remain constant across all the measurements in a data set.
            Examples might include fixed composition, pressure, or volume during
            an experiment.""",
        json_schema_extra=dict(),
    )
...
class Property(
    ...
    property_group: Optional[Property_Group] = element(
        default= None,
        tag="property_group",
...
class Variable(
    ...
    """
    variableID: Optional[str] = element(
        default= None,
        tag="variableID",
        json_schema_extra=dict(),
    )
    variableType: Optional[ConstraintVariableType] = element(
        default= None,
        tag="variableType",
        description="""eTemperture, ePressure, eComponentCompositon, eSolventComposition, eMiscellanous""",
        json_schema_extra=dict(),
    )
    variableName: Optional[str] = element(
        default= None,
        tag="variableName",
...
class Constraint(
    ...
    constraint_type: Optional[ConstraintVariableType] = element(
        default= None,
        tag="constraint_type",
        description="""Description what constraint is applicaple to the data. E.g. Pressure""",
        json_schema_extra=dict(),
    )
    constraint_digits: Optional[int] = element(
        default= None,
        tag="constraint_digits",
        json_schema_extra=dict(),
    )
    constraint_value: Optional[float] = element(
        default= None,
        tag="constraint_value",
        json_schema_extra=dict(),
    )
    constraint_number: Optional[int] = element(
        default= None,
        tag="constraint_number",
        json_schema_extra=dict(),
    )
...
class ConstraintVariableType(
    ...
    e_bio_variables: Optional[eBioVariables] = element(
        default= None,
        tag="e_bio_variables",
        json_schema_extra=dict(),
    )
    e_component_composition: Optional[eComponentComposition] = element(
        default= None,
        tag="e_component_composition",
        json_schema_extra=dict(),
    )
    e_miscellaneous: Optional[eMiscellaneous] = element(
        default= None,
        tag="e_miscellaneous",
        json_schema_extra=dict(),
    )
    e_participant_amount: Optional[eParticipantAmount] = element(
        default= None,
    ...
    e_solvent_composition: Optional[eSolventComposition] = element(
        default= None,
        tag="e_solvent_composition",
        json_schema_extra=dict(),
    )
    e_temperature: Optional[eTemperature] = element(
        default= None,
        tag="e_temperature",
        json_schema_extra=dict(),
    )
...
class NumValue(
    ...
    variableValue: Optional[VariableValue] = element(
        default= None,
        tag="variableValue",
        json_schema_extra=dict(),
    )
