...
class ModelMarkdownParser:
    ...
    def parse_classes(self) -> List[Dict[str, Any]]:
        ...
        for section in sections:
            ...
            if fields:
                classes.append({"name": class_name, "fields": fields})
    ...
    def _parse_class_fields(self, lines: List[str]) -> List[Dict[str, str]]:
        ...
        for line in lines:
            ...
            if re.match(r"^- \w+", line):
                ...
                current_field = {"name": field_name, "type": "", "description": ""}
    ...
    def parse_enums(self) -> List[Dict[str, Any]]:
        ...
        for enum_name, enum_content in enum_matches:
            ...
            if values:
                enums.append({"name": enum_name, "enum_values": values})
    ...
    def parse(self) -> Dict[str, Any]:
        ...
        return {"classes": self.classes, "enums": self.enums}


def generate_baml_from_markdown(
    markdown_file: str, template_file: str, output_file: str
):
